...
<ParamField body="memory_limit" type="integer" default="5">
  Number of semantic memories to retrieve.
</ParamField>

<ParamField body="turn_limit" type="integer" default="5">
...
```json Response
{
  "state": {
    "status": "active",
    "last_location": "Airport Level 4"
  },
  "memories": [
    {
      "content": "User parked in Section B2 of Level 4.",
      "type": "fact",
      "score": 0.94
    }
  ],
  "recent_turns": [
    {
      "id": "turn_01H...",
      "input": "I'm leaving for the flight now.",
      "output": "Got it. I've noted your parking spot."
    }
  ]
}
```
